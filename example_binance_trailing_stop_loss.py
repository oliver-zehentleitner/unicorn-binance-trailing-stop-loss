...
market = (
    "ETHUSDT"  # The stop loss order is created for the base asset (in this case ETH)
)
stop_loss_limit = (
    "1.5%"  # The distance to the maximum price at which the stop loss order is trailed
)
